...
| 経験・制作物 | 必須 | 1〜1,000文字 | 取り組んだ開発・制作物・担当した役割を記載。前後の空白を除去し、本文中の改行は保持 |
...
| bio | text | false | 経験・制作物、最大1,000文字。API互換性のためカラム名は維持 |
...
- 経験・制作物には記載内容の説明、現在文字数、1,000文字の上限を表示する。
